...
router_add('index', function(){
    ...
    <script>
        function cadastro_armario(codigo_armario){
            window.location.href = sistema.url('/armario.php', {'rota': 'salvar_alterar_dados', 'codigo_armario': codigo_armario});
        }
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-2 text-center">
                                ...
                                <input type="text" sistema-mask="codigo" class="form-control custom-radius" id="codigo_armario" placeholder="Código"/>
                            </div>
                            <div class="col-8 text-center">
                                <label class="text">Nome Armário</label>
                                <input type="text" class="form-control custom-radius" id="nome_armario" placeholder="Nome Armário"/>
                            </div>
                            <div class="col-2">
...
router_add('salvar_alterar_dados', function(){
    ...
    <script>
        ...
        function salvar_dados(){
            ...
            sistema.request.post('/armario.php', {'rota': 'salvar_dados', 'codigo_armario': codigo_armario, 'nome_armario': nome_armario, 'codigo_barras': codigo_barras}, function(retorno){
                sistema.verificar_status(retorno.status, sistema.url('/armario.php', {'rota':'index'}));
            });
        }
    </script>
    <div class="container-fluid">
    ...
    <script>
        window.onload = function(){
            if(CODIGO_ARMARIO != 0){
                sistema.request.post('/armario.php', {'rota': 'pesquisar_armario', 'codigo_armario': CODIGO_ARMARIO}, function(retorno){
