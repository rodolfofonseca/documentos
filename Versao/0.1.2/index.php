...
router_add('index', function(){
    ...
    <body>
      ...
      <?php
        ...
        $atualizacao->ativar_desativar_validacoes('documentos', 'off');
        
        $atualizacao->alterar_validacao('documentos', (array) ['id_documento' => (int) 0, 'id_caixa' => (int) 0, 'id_tipo_arquivo' => (int) 0, 'id_organizacao' => (int) 0, 'nome_documento' => (string) '', 'descricao' => (string) '', 'endereco' => (string) '', 'codigo_barras' => (string) '', 'quantidade_downloads' => (int) 0, 'cloudinary' => (int) 0]);
        
        $atualizacao->ativar_desativar_validacoes('documentos', 'strict');

        model_update('sistema', ['id_sistema', '===', (int) 1],['versao_sistema' => (string) '0.1.2']);
      ?>
