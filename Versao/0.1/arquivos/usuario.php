...
//@note alterar_informacoes_usuario_comum
/**
...
router_add('alterar_informacoes_usuario_comum', function () {
    ...
    <script>
        ...
        const PREFERENCIA_USUARIO_QUANTIDADE_DOCUMENTOS_POR_EXTENSAO = "<?php echo $preferencia_usuario_quantidade_documentos_por_extensao; ?>";
        const PREFERENCIA_USUARIO_TAMANHO_TOTAL_ARQUIVOS = "<?php echo $preferencia_usuario_tamanho_total_arquivos; ?>";
        ...
        /** 
         * Função responsável por alterar no banco de dados a preferência do usuário
        */
        function alterar_preferencia_usuario_quantidade_documentos_por_extensao(){
            let check_preferencia_usuario_quantidade_documentos_por_extensao = document.querySelector('#preferencia_usuario_quantidade_documentos_por_extensao');
            let preferencia = 'CHECKED';

            if(check_preferencia_usuario_quantidade_documentos_por_extensao.checked == true){
                preferencia = 'CHECKED';
            }else{
                preferencia = '';
            }

            sistema.request.post('/preferencia.php', {'rota': 'salvar_preferencia_usuario', 'codigo_sistema': CODIGO_SISTEMA, 'codigo_usuario': CODIGO_USUARIO, 'nome_preferencia': 'USUARIO_PREFERENCIA_RELATORIO_QUANTIDADE_DOCUMENTOS_POR_EXTENSAO', 'preferencia': preferencia}, function(retorno){}, false);
        }
        
        /** 
         * Função responsável por alterar a preferência do usuário quanto ao usuário visualizar o relatório de tamanho total de arquivos.
        */
        function alterar_preferencia_usuario_tamanho_total_arquivos(){
            let check_preferencia_usuario_tamanho_total_arquivos = document.querySelector('#preferencia_usuario_tamanho_total_arquivos');
            let preferencia = 'CHECKED';
            
            if(check_preferencia_usuario_tamanho_total_arquivos.checked == true){
                preferencia = 'CHECKED';
            }else{
                preferencia = '';
            }
            
            sistema.request.post('/preferencia.php', {'rota': 'salvar_preferencia_usuario', 'codigo_sistema': CODIGO_SISTEMA, 'codigo_usuario': CODIGO_USUARIO, 'nome_preferencia': 'USUARIO_PREFRENCIA_RELATORIO_TAMANHO_TOTAL_ARQUIVO', 'preferencia': preferencia}, function(retorno){}, false);
    ...
    <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <button class="btn btn-info botao_vertical_linha custom-radius botao_grande" onclick="salvar_dados();">Salvar Dados</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        if(TIPO_USUARIO == 'ADMINISTRADOR'){
            ?>
            <div class="row" id="preferencia_usuario">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-center">Relatórios na dashboard</h4>
                            <br/>
                            <div class="row">
                                <div class="col-1 text-center">
                                    <input type="checkbox" id="preferencia_usuario_quantidade_documentos_por_extensao" class="form-control custom-radius" alt="Quantidade de arquivos por tipo de documento" onclick="alterar_preferencia_usuario_quantidade_documentos_por_extensao();" <?php echo $preferencia_usuario_quantidade_documentos_por_extensao; ?> />
                                </div>
                                 <div class="col-2">
                                    <label for="preferencia_usuario_quantidade_documentos_por_extensao">Quantidade de arquivos por tipo de documento</label>
                                </div>
                                <div class="col-1 text-center">
                                    <input type="checkbox" id="preferencia_usuario_tamanho_total_arquivos" class="form-control custom-radius" alt="Tamanho total de arquivos" onclick="alterar_preferencia_usuario_tamanho_total_arquivos();" <?php echo $preferencia_usuario_tamanho_total_arquivos; ?>/>
                                </div>
                                <div class="col-2">
                                    <label for="preferencia_usuario_tamanho_total_arquivos">Tamanho total arquivos</label>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        window.onload = function() {
            validar_acesso_administrador(TIPO_USUARIO);
