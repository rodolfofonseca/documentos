...
router_add('index', function(){
    ...
    <body>
      ...
      <?php
        ...
        $atualizacao->criar_tabela_banco_dados('usuario', (array) ['id_usuario' => (int) 0, 'nome_usuario' => (string) '', 'login' => (string) '', 'senha_usuario' => (string) '', 'tipo' => (string)'COMUM']);
        ...
        $usuario_adm = (array) ['id_usuario' => (int) model_next('usuario', 'id_usuario'), 'nome_usuario' => (string) 'RODOLFO ANGELO VIEIRA FONSECA', 'login' => (string) 'rodolfo', 'senha_usuario' => (string) password_hash('crydo879', PASSWORD_DEFAULT, ['const' => 8]), 'tipo' => (string)'ADMINISTRADOR'];
        ...
        model_insert('sistema', ['id_sistema' => (int) 1, 'versao_sistema' => (string) '0.1']);
      ?>
